...
export function MenuImageField({ value, onChange }) {
  ...
  return (
    <div>
      {value ? (
        <div className="relative h-24 w-full overflow-hidden rounded-[var(--radius-md)] border border-[var(--border)]">
        ...
        <button
          ...
          disabled={uploading}
          className="flex h-20 w-full flex-col items-center justify-center gap-1 rounded-[var(--radius-md)] border border-dashed border-[var(--border)] text-[var(--text-faint)] hover:border-[var(--brand-500)] hover:text-[var(--brand-500)]"
        >
          <ImagePlus size={18} />
